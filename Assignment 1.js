...
character.characterName = "Saurav"
...
character.greet = function(){
    alert(`He is ${character.characterName} ${character["sur name"]} and his title is ${character.title}`);
}
